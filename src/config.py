...
class Settings(BaseSettings):
    ...
    about_text: str = (
        "<b>Atlas</b> — быстрый и стабильный VPN-сервис на базе протокола "
        "VLESS+Reality. Создан, чтобы открывать заблокированные сайты и сервисы "
        "без боли с настройкой.\n\n"
        "🔥 <b>Что даёт Atlas VPN?</b>\n\n"
        "• Сторис и рилсы всегда под рукой\n"
        "• Маскировка под обычный HTTPS — работает там, где другие уже не открываются\n"
        "• Поддержка, которая всегда на связи\n"
        "• Подключение до 10 устройств с одной подписки\n"
        "• Работает на смартфоне, ноутбуке, планшете и даже на телевизоре\n\n"
        "Atlas обеспечивает безопасное и стабильное соединение для работы, "
        "игр и просмотра YouTube в 4K — где угодно. 🚀"
    )
    offer_text: str = (
